    ...
    <div class="max-w-md w-full">
      ...
      <form class="mt-8" wire:submit.prevent="login">
        ...
        <div class="rounded-md shadow-sm">
          ...
          <div class="-mt-px">
            <input wire:model.lazy="password" aria-label="Password" name="password" type="password" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5" placeholder="Password">
        </div>
        </div>
